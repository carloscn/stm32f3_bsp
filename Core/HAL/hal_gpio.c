...
static int32_t stm32f3xx_gpio_a9_init_map_to_gpio_0(void)
{
...
static void stm32f3xx_gpio_a9_deinit_map_to_gpio_0(void)
{
    HAL_GPIO_DeInit(GPIOA, GPIO_PIN_9);
}

static int32_t stm32f3xx_gpio_a9_read_pin_map_to_gpio_0(HAL_GPIO_PIN_STATE *res)
{
...
static void stm32f3xx_gpio_a9_write_pin_map_to_gpio_0(GPIO_PinState value)
{
    HAL_GPIO_WritePin(GPIOA, GPIO_PIN_9, value);
}

static void stm32f3xx_gpio_a9_toggle_pin_map_to_gpio_0(void)
{
    HAL_GPIO_TogglePin(GPIOA, GPIO_PIN_9);
}

static int32_t stm32f3xx_gpio_a9_lock_pin_map_to_gpio_0(void)
{
    int32_t ret = HAL_SUCCESS;
...
static int32_t stm32f3xx_gpio_b7_init_map_to_gpio_1(void)
{
...
static void stm32f3xx_gpio_b7_deinit_map_to_gpio_1(void)
{
    HAL_GPIO_DeInit(GPIOB, GPIO_PIN_7);
}

static int32_t stm32f3xx_gpio_b7_read_pin_map_to_gpio_1(HAL_GPIO_PIN_STATE *res)
{
    int32_t ret = HAL_SUCCESS;
...
static void stm32f3xx_gpio_b7_write_pin_map_to_gpio_1(GPIO_PinState value)
{
    HAL_GPIO_WritePin(GPIOB, GPIO_PIN_7, value);
}

static void stm32f3xx_gpio_b7_toggle_pin_map_to_gpio_1(void)
{
    HAL_GPIO_TogglePin(GPIOB, GPIO_PIN_7);
}

static int32_t stm32f3xx_gpio_b7_lock_pin_map_to_gpio_1(void)
{
    int32_t ret = HAL_SUCCESS;
    HAL_StatusTypeDef ret_x = \
...
static int32_t stm32f3xx_gpio_c7_init_map_to_gpio_2(void)
{
...
static void stm32f3xx_gpio_c7_deinit_map_to_gpio_2(void)
{
    HAL_GPIO_DeInit(GPIOC, GPIO_PIN_7);
}

static int32_t stm32f3xx_gpio_c7_read_pin_map_to_gpio_2(HAL_GPIO_PIN_STATE *res)
{
    int32_t ret = HAL_SUCCESS;
...
static void stm32f3xx_gpio_c7_write_pin_map_to_gpio_2(GPIO_PinState value)
{
    HAL_GPIO_WritePin(GPIOC, GPIO_PIN_7, value);
}

static void stm32f3xx_gpio_c7_toggle_pin_map_to_gpio_2(void)
{
    HAL_GPIO_TogglePin(GPIOC, GPIO_PIN_7);
}

static int32_t stm32f3xx_gpio_c7_lock_pin_map_to_gpio_2(void)
{
    int32_t ret = HAL_SUCCESS;
    HAL_StatusTypeDef ret_x = \
...
int32_t hal_gpio_init(HAL_GPIO_CTX *gpio)
{
    ...
    switch(gpio->hal_num) {
        case HAL_GPIO_0:
            ret = stm32f3xx_gpio_a9_init_map_to_gpio_0();
            if (ret != HAL_SUCCESS) {
                goto finish;
            }
            break;
        case HAL_GPIO_1:
            ret = stm32f3xx_gpio_b7_init_map_to_gpio_1();
            if (ret != HAL_SUCCESS) {
                goto finish;
            }
            break;
        case HAL_GPIO_2:
            ret = stm32f3xx_gpio_c7_init_map_to_gpio_2();
            if (ret != HAL_SUCCESS) {
                goto finish;
            }
            break;
...
void hal_gpio_deinit(HAL_GPIO_CTX *gpio)
{
    ...
    switch(gpio->hal_num) {
        case HAL_GPIO_0:
            stm32f3xx_gpio_a9_deinit_map_to_gpio_0();
            return;
        case HAL_GPIO_1:
            stm32f3xx_gpio_b7_deinit_map_to_gpio_1();
            return;
        case HAL_GPIO_2:
            stm32f3xx_gpio_c7_deinit_map_to_gpio_2();
            return;
#if LOCK_CODE
        case HAL_GPIO_3:
        case HAL_GPIO_4:
...
int32_t hal_gpio_read_pin(HAL_GPIO_CTX *gpio, HAL_GPIO_PIN_STATE *res)
{
    ...
    switch(gpio->hal_num) {
        case HAL_GPIO_0:
            ret = stm32f3xx_gpio_a9_read_pin_map_to_gpio_0(res);
            if (ret != HAL_SUCCESS) {
                goto finish;
            }
            break;
        case HAL_GPIO_1:
            ret = stm32f3xx_gpio_b7_read_pin_map_to_gpio_1(res);
            if (ret != HAL_SUCCESS) {
                goto finish;
            }
            break;
        case HAL_GPIO_2:
            ret = stm32f3xx_gpio_c7_read_pin_map_to_gpio_2(res);
            if (ret != HAL_SUCCESS) {
                goto finish;
            }
            break;
...
int32_t hal_gpio_write_pin(HAL_GPIO_CTX *gpio, HAL_GPIO_PIN_STATE state)
{
    ...
    switch(gpio->hal_num) {
        case HAL_GPIO_0:
            stm32f3xx_gpio_a9_write_pin_map_to_gpio_0(s);
            break;
        case HAL_GPIO_1:
            stm32f3xx_gpio_b7_write_pin_map_to_gpio_1(s);
            break;
        case HAL_GPIO_2:
            stm32f3xx_gpio_c7_write_pin_map_to_gpio_2(s);
            break;
#if LOCK_CODE
        case HAL_GPIO_3:
        case HAL_GPIO_4:
...
int32_t hal_gpio_toggle_pin(HAL_GPIO_CTX *gpio)
{
    ...
    switch(gpio->hal_num) {
        case HAL_GPIO_0:
            stm32f3xx_gpio_a9_toggle_pin_map_to_gpio_0();
            break;
        case HAL_GPIO_1:
            stm32f3xx_gpio_b7_toggle_pin_map_to_gpio_1();
            break;
        case HAL_GPIO_2:
            stm32f3xx_gpio_c7_toggle_pin_map_to_gpio_2();
            break;
#if LOCK_CODE
        case HAL_GPIO_3:
        case HAL_GPIO_4:
...
int32_t hal_gpio_lock_pin(HAL_GPIO_CTX *gpio)
{
    ...
    switch(gpio->hal_num) {
        case HAL_GPIO_0:
            ret = stm32f3xx_gpio_a9_lock_pin_map_to_gpio_0();
            if (ret != HAL_SUCCESS) {
                goto finish;
            }
            break;
        case HAL_GPIO_1:
            ret = stm32f3xx_gpio_b7_lock_pin_map_to_gpio_1();
            if (ret != HAL_SUCCESS) {
                goto finish;
            }
            break;
        case HAL_GPIO_2:
            ret = stm32f3xx_gpio_c7_lock_pin_map_to_gpio_2();
            if (ret != HAL_SUCCESS) {
                goto finish;
            }
            break;
